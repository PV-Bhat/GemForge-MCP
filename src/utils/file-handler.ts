 ...
 */
export function getFileTypeCategory(filePathOrMimeType: string): string {
 ...
 */
export function normalizeFileInput(fileInput: FileInput['file_path']): string[] {
  if (!fileInput) return [];
 ...
 */
export async function concatenateFiles(filePaths: string[], separator: string = '\n\n------- NEW FILE -------\n\n'): Promise<string> {
