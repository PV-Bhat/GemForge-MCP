...
import { SearchArgs, ReasonArgs, CodeArgs, FileopsArgs } from '../interfaces/tool-args.js';
 ...
 */
function selectSearchModel(args: SearchArgs): string {
 ...
 * @returns Selected model ID
 */
function selectReasonModel(args: ReasonArgs): string {
  // User-provided model_id has highest priority
  if (args.model_id) {
 ...
 * @returns Selected model ID
 */
function selectCodeModel(args: CodeArgs): string {
  // User-provided model_id has highest priority
  if (args.model_id) {
 ...
 * @returns Selected model ID
 */
function selectFileopsModel(args: FileopsArgs): string {
  // User-provided model_id has highest priority
  if (args.model_id) {
 ...
 * @returns Selected model ID
 */
export function selectToolModel(toolName: string, args: any): string {
