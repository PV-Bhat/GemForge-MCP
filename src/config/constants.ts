...
export const ERROR_MESSAGES = {
  ...
  THINKING_NOT_SUPPORTED: (modelDisplayName: string) =>
    `Thinking mode is not supported by ${modelDisplayName}. Please use Gemini 2.5 Pro.`,

  /** Search capability error */
  SEARCH_NOT_SUPPORTED: (modelDisplayName: string) =>
    `Search integration is not supported by ${modelDisplayName}. Please use Gemini 2.5 Flash or Gemini 2.0 Flash.`,

  /** Model not found error */
  MODEL_NOT_FOUND: (modelId: string) =>
    `Model ${modelId} not found. Please check available models and their supported methods.`,
};
